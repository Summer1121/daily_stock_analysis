...
各配置项的含义与作用见 **[配置准备清单](docs/配置准备清单.md)**，下表为速查。
...
> 📋 **配置准备**：需要准备哪些配置、每项做什么用？请查看 **[配置准备清单](docs/配置准备清单.md)**。

> 💡 **新增功能**：系统现已支持模拟交易和历史回测功能！  
> 详细操作请参考 **[交易与回测功能操作手册](docs/trading_guide.md)**。

> 📖 完整环境变量、定时任务配置请参考 [配置指南](docs/config-guide.md) 与 [文档中心](docs/full-guide.md)。
